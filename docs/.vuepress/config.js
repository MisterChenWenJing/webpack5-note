  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/base/': [
        {
          text: '基础配置',
          children: ['/base/README.md', '/base/base.md', '/base/config.md', '/base/development.md', '/base/css.md', '/base/image.md', '/base/output.md', '/base/clean.md', '/base/font.md', '/base/other.md', '/base/javascript.md', '/base/html.md', '/base/server.md', '/base/production.md', '/base/optimizeCss.md', '/base/minifyHtml.md', '/base/summary.md']
        }
      ],
      '/senior/': [
        {
